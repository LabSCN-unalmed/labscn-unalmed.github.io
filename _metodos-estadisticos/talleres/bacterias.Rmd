...
![](BacteriasEnCarne.png)

### Primer taller individual

Realice un análisis exploratorio de los datos y de acuerdo a ese análisis
escriba una posible respuesta a la pregunta de investigación planteada.

No debe realizar ningun análisis de varianza (ANOVA o ANAVA).

### Documentos a entregar
  - Archivo de datos en formato ".csv".
  - Archivo en formato html con en análisis exploratorio que incluya
    el código utilizado para obtener los resultados.

### Fecha de entrega

Jueves 9 de febrero de 2017 al correo krcabrer@unal.edu.co
antes de las 23:59 hora de colombia, no olvidar en asunto escribir 
**[MEDE]**.
