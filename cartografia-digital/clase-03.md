...
![Cuarta versión]({{ site.baseurl }}/cartografia-digital/images/TC_porce4.png){: .img-responsive .img-rounded}
...
![Primera versión]({{ site.baseurl }}/cartografia-digital/images/TC_porce6.png){: .img-responsive .img-rounded}
