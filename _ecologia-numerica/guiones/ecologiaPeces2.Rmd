...
El [artículo](./docs/diversity-vegan.pdf) asocidado al paquete
**vegan** del autor Jari Oksanen ofrece una orientación a aspectos
del uso de los parámetros de diversidad.
...
op<-par(no.readonly = TRUE)
par(mfrow = c(2,2))
plot(ambient$das, ambient$alt, type = "l", xlab = "Distancia desde el nacimiento [km]", 
     ylab = "Altitud (m)", col = "red", main = "Altura")
plot(ambient$das, ambient$flo, type = "l", xlab = "Distancia desde el nacimiento [km]", 
     ylab = "Descarga (m3/s)", col = "blue", main = "Descarga")
plot(ambient$das, ambient$oxy, type = "l", xlab = "Distancia desde el nacimiento [km]", 
     ylab = "Oxígeno (mg/L)", col = "green3", main = "Oxígeno")
plot(ambient$das, ambient$nit, type = "l", xlab = "Distancia desde el nacimiento [km]", 
