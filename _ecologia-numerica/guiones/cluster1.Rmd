...
plot(peces.ch.single$order,ambient$das, pch = 19)
text(peces.ch.single$order, ambient$das, 
     labels =peces.ch.single$labels[peces.ch.single$order[peces.ch.single$order]], pos = 2)
...
plot(peces.ch.single$order,ambient$nit, pch = 19)
text(peces.ch.single$order, ambient$das, 
     labels =peces.ch.single$labels[peces.ch.single$order[peces.ch.single$order]], pos = 2)
